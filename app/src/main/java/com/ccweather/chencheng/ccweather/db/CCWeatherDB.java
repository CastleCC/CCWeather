...
package com.ccweather.chencheng.ccweather.db;
...
public class CCWeatherDB{
     ...
     * 数据库名
     */
    public static final String DB_NAME = "cc_weather";
    ...
    private CCWeatherDB(Context context){
        CCWeatherOpenHelper dbHelper = new CCWeatherOpenHelper(context, DB_NAME, null, VERSION);
    ...
    public List<City> loadCities(int provinceId) {
        ...
        if (cursor.moveToFirst()) {
            do { City city = new City();
                ...
                city.setProvinceId(provinceId); list.add(city); } while (cursor.moveToNext());
        }
    ...
    public List<County> loadCounties(int cityId) {
        ...
        if (cursor.moveToFirst()) {
            do { County county = new County();
                ...
                county.setCityId(cityId); list.add(county); } while (cursor.moveToNext());
        } return list;
    }
